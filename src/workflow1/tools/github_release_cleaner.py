"""Clean workflow1 for a public GitHub release.
...
1. Install workflow1 in editable mode.
...
- Prepared workflow1 for public use as a Codex-assisted scientific workflow scaffold.
""",
...
The public repository keeps framework code, registries, recipes, skills, and
...
def scan_remaining_risks(repo_root: Path, planned_deletions: set[str] | None = None) -> list[str]:
    ...
    sensitive_assignments = ("api_key", "apikey", "secret", "password", "access_token")
    safe_suffixes = {".pyc"}
