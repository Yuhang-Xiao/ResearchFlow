...
ZOTERO_CREDENTIAL_ENV = "ZOTERO_" + "API" + "_" + "KEY"
...
def _collection_readback_status(config_text: str, port_open: bool) -> dict[str, Any]:
    ...
    headers = {}
    api_key = os.environ.get(ZOTERO_CREDENTIAL_ENV)
    if api_key:
...
def check_zotero_mcp_readiness(config_path: str | Path = ".codex/config.toml") -> dict[str, Any]:
    ...
    return {
        ...
        "zotero_credential_env_present": bool(os.environ.get(ZOTERO_CREDENTIAL_ENV)),
