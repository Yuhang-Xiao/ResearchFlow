...
def build_product_orchestration_dry_run(
    ...
    return {
        ...
        "recipes": [
            "framework/workflow_recipes/auto_research_product_orchestrator.yaml",
            "framework/workflow_recipes/one_sentence_to_research_product.yaml",
            "framework/workflow_recipes/literature_first_research_workflow.yaml",
            "framework/workflow_recipes/multi_task_modeling_planner.yaml",
            "framework/workflow_recipes/metric_completeness_gate.yaml",
            "framework/workflow_recipes/model_comparison_gate.yaml",
            "framework/workflow_recipes/explainability_gate.yaml",
            "framework/workflow_recipes/figure_table_product_gate.yaml",
            "framework/workflow_recipes/full_paper_product_gate.yaml",
            "framework/workflow_recipes/paper_product_generation_orchestrator.yaml",
            "framework/workflow_recipes/research_quality_gate_orchestrator.yaml",
            "framework/workflow_recipes/auto_repair_loop.yaml",
        ],
