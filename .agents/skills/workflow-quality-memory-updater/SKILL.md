---
name: workflow-quality-memory-updater
description: Use when the task mentions 任务结束质量复盘, project memory, workflow improvement backlog. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
