---
name: local-skill-adapter
description: Convert external skill patterns into local SKILL.md files without copying uncontrolled code. Trigger phrases include: local-skill-adapter, workflow upgrade, skill scout
---
