---
name: workflow-upgrade-ledger-manager
description: Record workflow improvement candidates, decisions, applied patches, and rejected items. Trigger phrases include: workflow-upgrade-ledger-manager, workflow upgrade, skill scout
---
