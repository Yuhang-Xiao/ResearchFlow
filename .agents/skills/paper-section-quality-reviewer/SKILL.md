---
name: paper-section-quality-reviewer
description: Use when the task mentions 论文质量检查, paper section review, Word 输出前核验. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
