---
name: model-validation-and-diagnostics-runner
description: Use when the task mentions 模型验证, diagnostics, drift, leakage. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
