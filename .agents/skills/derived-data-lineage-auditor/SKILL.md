---
name: derived-data-lineage-auditor
description: Use when the task mentions 派生数据核验, lineage audit, data_lineage_manifest. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
