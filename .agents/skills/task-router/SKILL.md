...
Use this skill at the start of a research workflow request when the correct next step is unclear or when a task may span multiple workflow areas. If the user provides raw data plus a research objective, route to `.agents/skills/autonomous-research-orchestrator` for end-to-end execution.
