---
name: baseline-fairness-auditor
description: Use when the task mentions baseline fairness, baseline 公平性, 可解释对照. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
