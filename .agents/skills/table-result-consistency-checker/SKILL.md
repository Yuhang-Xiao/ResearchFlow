---
name: table-result-consistency-checker
description: Use when the task mentions 表格和报告数字核对, table consistency. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
