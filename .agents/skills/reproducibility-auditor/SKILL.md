...
description: Use when the task mentions reproducibility, 可复现实验, seed/config/hash. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
