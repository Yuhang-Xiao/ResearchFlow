---
name: safe-workflow-upgrade-planner
description: Turn evaluated candidates into safe local upgrade plans and approval-required proposals. Trigger phrases include: safe-workflow-upgrade-planner, workflow upgrade, skill scout
---
