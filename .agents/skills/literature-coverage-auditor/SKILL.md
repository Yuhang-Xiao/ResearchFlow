---
name: literature-coverage-auditor
description: Use when the task mentions 文献覆盖, literature coverage, 文献质量检查. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
