---
name: zotero-writeback-and-note-validator
description: Use when the task mentions Zotero 写入计划, 无乱码中文笔记, citation verification. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
