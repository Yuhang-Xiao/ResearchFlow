---
name: academic-writing-and-results-writer
description: Use when the task mentions 论文质量检查, evidence map, citation verification, result claim guard, Word DOCX 输出. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
