...
description: Search GitHub skill libraries, agents, and frameworks, then adapt safe ideas as local workflow1 assets. Trigger phrases include: github-skill-scout-and-adapter, workflow upgrade, skill scout
---
