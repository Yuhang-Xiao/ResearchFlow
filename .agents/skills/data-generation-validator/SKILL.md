---
name: data-generation-validator
description: Use when the task mentions 数据生成核验, generated data validation, 数据输出检查. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
