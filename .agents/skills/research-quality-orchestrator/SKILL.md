---
name: research-quality-orchestrator
description: Use when the task mentions 核验结果, quality gate, 科研质量核验, result claim guard. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
