---
name: top-journal-benchmark-scout
description: Use when the task mentions 顶级期刊对标, top journal benchmark, 高质量论文检索. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
