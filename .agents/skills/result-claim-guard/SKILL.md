---
name: result-claim-guard
description: Use when the task mentions result claim guard, 论文论断保护, 过度推断. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
