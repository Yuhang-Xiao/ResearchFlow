...
description: Check skill discoverability, trigger phrases, duplicate names, missing fields, and local skill registry health. Trigger phrases include: skill-registry-doctor, workflow upgrade, skill scout
---
