---
name: skill-registry-doctor
description: Check skill discoverability, trigger phrases, duplicate names, missing fields, and sync between skills directories. Trigger phrases include: skill-registry-doctor, workflow upgrade, skill scout
---
