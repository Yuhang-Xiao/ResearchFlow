---
name: chart-quality-auditor
description: Use when the task mentions 图表 QA, 空图检测, 中文字体, PNG 输出. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
