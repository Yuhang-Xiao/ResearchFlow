...
description: Use when the task mentions adversarial reviewer, 对抗式审稿, robust audit. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
