---
name: top-journal-method-comparator
description: Use when the task mentions 方法对标, 模型设定对标, top journal method comparator. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
