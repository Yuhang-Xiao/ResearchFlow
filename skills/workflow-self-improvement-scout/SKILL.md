...
description: Scan workflow1 gaps and search GitHub/open-source projects for safe workflow upgrades. Trigger phrases include: 优化工作流, 升级工作流, 让 Codex 自己寻找 skill, 搜索 GitHub 改进 workflow, 扩展自动科研能力, self-improve workflow, workflow upgrade, skill scout, one-line research workflow
---
