---
name: local-explanation-writer
description: Write local and instance-level explanation summaries without causal overclaim.
---
...
Write local and instance-level explanation summaries without causal overclaim.
