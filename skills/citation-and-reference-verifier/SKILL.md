---
name: citation-and-reference-verifier
description: Use when the task mentions citation verification, 引用核验, DOI核验. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
