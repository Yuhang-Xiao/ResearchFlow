---
name: external-plugin-approval-manager
description: Maintain approval queue for MCP, API, Zotero, dependency, plugin, and service upgrades. Trigger phrases include: external-plugin-approval-manager, workflow upgrade, skill scout
---
