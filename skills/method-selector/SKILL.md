...
Use this skill after the problem is framed and before implementing modeling, statistical analysis, matching, or evaluation methods.
...
6. Record durable method choices in `project_state/decision_log.md`.
