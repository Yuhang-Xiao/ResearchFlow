---
name: model-comparison-auditor
description: Use when the task mentions 模型对比, 多模型比较, model comparison. It enforces workflow1 research quality gates and produces Chinese-first audit outputs.
---
